...
(function() {
  ...
  MT('image',
      'An avatar_url: [string !http://www.example.com/image.png!]');

  MT('imageWithAltText',
      'An avatar_url: [string !http://www.example.com/image.png (Alt Text)!]');

  MT('imageWithUrl',
      'An avatar_url: [string !http://www.example.com/image.png!:http://www.example.com/]');
